        ...
        while (matcher.find()) {
          ...
          if (doubleQuoted != null) {
            if (singleQuoted != null) {
              throw new IllegalArgumentException(varName + ": Found both in double quotes (\") and single quotes ('): " + matcher.group());
            }
            value = doubleQuoted;
          } else {
    ...
    if (text == null) {
      ...
      if (comment == null) {
        ...
        while (textPos < textLen || commentPos < commentLen) {
          ...
          if (textCh == '<' || textCh == '>') {
            throw new IllegalArgumentException("Generics not allowed directly in child element (" + childTagName + "): \"" + text + "\"");
          }
          ...
          if (commentCh == '<') {
            ...
            do {
              if (commentPos >= commentLen) {
                throw new IllegalArgumentException("Incomplete generic segment in variable-comment (" + varName + "): \"" + comment + "\"");
              }
